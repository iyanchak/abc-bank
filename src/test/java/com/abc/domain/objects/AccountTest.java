...
/**
 * Test Account domain object For daily interest rates, the expected rate was
 * calculated manually using Windows 10 calculator. E.g. for multiple day
 * transaction in maxi savings account done on three days 365 ago, 182 ago, 91
 * ago the interest rate accrued is: (9.9778910204323415116791735909692+
 * 24.763565242231429895420724745376+ 24.472895787683816075965225393111)+
 * (4.9493009078485256048770098422766+ 9.291574211057275642684627949108)+
...
public class AccountTest {
	...
	public void setup() {
		dateTimeProvider365DaysAgo = new DateTimeProvider() {
			...
			public LocalDateTime now() {
				LocalDateTime date = new DateTestHelperImpl().getMultiDaysAgoOrNowBasedOnCounter(counter,
						new long[] { 365 });
				counter++;
				return date;
			}
	...
	public void testSavingsEarnedInterestRateUnder1000After182Days() throws BusinessException {
		...
		savingAccount.deposit(750.0);
		assertEquals(0.37387890033155988310599788363523, savingAccount.calculateInterestEarned(),
	...
	public void testSavingsEarnedInterestRateOver1000After182Days() throws BusinessException {
		Account savingAccount = new Account(AccountType.SAVINGS, dateTimeProvider182DaysAgo);
		savingAccount.deposit(1250.0);
		assertEquals(0.74769539483045061054276355856288, savingAccount.calculateInterestEarned(),
				Precision.DOUBLE_PRECISION);
	}
	...
	public void testMaxiSavingsEarnedInterestRateUnder1000After182Days() throws BusinessException {
		...
		maxiSavingAccount.deposit(750.0);
		assertEquals(7.4423230463801110871215505228452, maxiSavingAccount.calculateInterestEarned(),
				Precision.DOUBLE_PRECISION);
	}
	...
	public void testMaxiSavingsEarnedInterestRateUnder2000After182Days() throws BusinessException {
		...
		savingAccount.deposit(1700.0);
		assertEquals(27.161712164095583757370851084434, savingAccount.calculateInterestEarned(),
				Precision.DOUBLE_PRECISION);
	}
	...
	public void testMaxiSavingsEarnedInterestRateOver2000After182Days() throws BusinessException {
		Account savingAccount = new Account(AccountType.MAXI_SAVINGS, dateTimeProvider182DaysAgo);
		savingAccount.deposit(2500.0);
		assertEquals(58.885651243884128036848612945029, savingAccount.calculateInterestEarned(),
				Precision.DOUBLE_PRECISION);
	}
	...
	public void testSavingsEarnedInterestRateAfterMultipleDays() throws BusinessException {
		...
		assertEquals(1.1240038055589322706501103217248, savingAccount.calculateInterestEarned(),
				Precision.DOUBLE_PRECISION);
	}
	...
	public void testMaxiSavingsEarnedInterestRateAlfterMultipleDays() throws BusinessException {
		...
		assertEquals(77.530754872654788414707002411118, savingAccount.calculateInterestEarned(),
				Precision.DOUBLE_PRECISION);
